package com.forgestory.ui
{
	...
	public class ItemPanel extends Panel
	{
		...
		public function ItemPanel(parent:DisplayObjectContainer = null, xPos:Number = 0, yPos:Number = 0, item:ItemViewer= null){
			if(!item){
				this.item= new ItemViewer();
			}else{
				this.item = item;
			}
